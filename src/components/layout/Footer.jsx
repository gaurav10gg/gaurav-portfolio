...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    social: [
      { name: 'LinkedIn', href: 'https://www.linkedin.com/in/gaurav10g/', icon: 'linkedin' },
      { name: 'GitHub', href: 'https://github.com/gaurav10gg', icon: 'github' },
    ],
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <p className="text-gray-400">
            © {currentYear} Portfolio. All rights reserved. Built with React & Tailwind CSS.
          </p>
        </motion.div>
      </div>
    </footer>
